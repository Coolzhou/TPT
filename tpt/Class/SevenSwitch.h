...
typedef enum : NSUInteger {
    SevenSwitchImageType,
    SevenSwitchTitleType
} SevenSwitchType;
...
@property (nonatomic, strong) NSString *onTitleStr;

@property (nonatomic, strong) NSString *offTitleStr;

@property (nonatomic)SevenSwitchType selectType;
